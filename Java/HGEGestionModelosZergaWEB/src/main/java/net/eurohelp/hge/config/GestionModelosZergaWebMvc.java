...
@Configuration
@ComponentScan({ "net.eurohelp.hge.*" })
@EnableTransactionManagement
public abstract class GestionModelosZergaWebMvc extends WebMvcConfigurerAdapter {
  ...
  public String[] addMessageSourceBaseNames() {
    return new String[] { "net/eurohelp/hge/gestionmodeloszerga/web/resources/ApplicationResources" };
  }
