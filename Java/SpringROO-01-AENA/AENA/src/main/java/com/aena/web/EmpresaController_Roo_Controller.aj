...
import com.aena.web.EmpresaController;
...
privileged aspect EmpresaController_Roo_Controller {
    ...
    public String EmpresaController.create(@Valid Empresa empresa, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        empresa.persist();
        return "redirect:/empresas/" + encodeUrlPathSegment(empresa.getIdEmpresa().toString(), httpServletRequest);
    }
    ...
    @RequestMapping(value = "/{idEmpresa}", produces = "text/html")
    public String EmpresaController.show(@PathVariable("idEmpresa") Integer idEmpresa, Model uiModel) {
        uiModel.addAttribute("empresa", Empresa.findEmpresa(idEmpresa));
        uiModel.addAttribute("itemId", idEmpresa);
    ...
    @RequestMapping(value = "/{idEmpresa}", params = "form", produces = "text/html")
    public String EmpresaController.updateForm(@PathVariable("idEmpresa") Integer idEmpresa, Model uiModel) {
        populateEditForm(uiModel, Empresa.findEmpresa(idEmpresa));
        return "empresas/update";
    }
    
    @RequestMapping(value = "/{idEmpresa}", method = RequestMethod.DELETE, produces = "text/html")
    public String EmpresaController.delete(@PathVariable("idEmpresa") Integer idEmpresa, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Empresa empresa = Empresa.findEmpresa(idEmpresa);
        empresa.remove();
        uiModel.asMap().clear();
