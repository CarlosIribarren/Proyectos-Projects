...
import com.aena.web.UsuarioController;
...
privileged aspect UsuarioController_Roo_Controller {
    ...
    public String UsuarioController.create(@Valid Usuario usuario, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        usuario.persist();
        return "redirect:/usuarios/" + encodeUrlPathSegment(usuario.getIdUsuario().toString(), httpServletRequest);
    }
    ...
    public String UsuarioController.show(@PathVariable("idUsuario") Integer idUsuario, Model uiModel) {
        uiModel.addAttribute("usuario", Usuario.findUsuario(idUsuario));
    ...
    public String UsuarioController.updateForm(@PathVariable("idUsuario") Integer idUsuario, Model uiModel) {
        populateEditForm(uiModel, Usuario.findUsuario(idUsuario));
        return "usuarios/update";
    }
    
    @RequestMapping(value = "/{idUsuario}", method = RequestMethod.DELETE, produces = "text/html")
    public String UsuarioController.delete(@PathVariable("idUsuario") Integer idUsuario, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
